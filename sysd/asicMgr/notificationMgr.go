...
func initAsicdNotification() commonDefs.AsicdNotification {
	...
	nMap = commonDefs.AsicdNotification{
		...
		commonDefs.NOTIFY_L3INTF_STATE_CHANGE:       false,
...
func NewNotificationHdl(server *server.SYSDServer,
	logger *logging.Writer) (commonDefs.AsicdNotificationHdl, commonDefs.AsicdNotification) {
...
func (nHdl *NotificationHdl) ProcessNotification(msg commonDefs.AsicdNotifyMsg) {
	nHdl.Server.AsicSubSocketCh <- msg
}
